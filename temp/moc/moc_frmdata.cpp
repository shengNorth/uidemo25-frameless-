...
QT_MOC_LITERAL(4, 26, 8), // "initIcon"
QT_MOC_LITERAL(5, 35, 13) // "buttonClicked"

    },
    "frmData\0initForm\0\0initNav\0initIcon\0"
    "buttonClicked"
};
...
void frmData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<frmData *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject frmData::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_frmData.data,
    qt_meta_data_frmData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
